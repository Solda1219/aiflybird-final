...
const businessContactController= require('../controller/business_contact');
const plansController= require('../controller/plans');
//user authentication
router.post('/isEmailNameUnique', AuthenticationController.isEmailNameUnique);
router.post('/isEmailExists', AuthenticationController.isEmailExists);
router.post('/sendVerifyEmail', AuthenticationController.sendVerifyEmail);
router.get('/verifyCode', AuthenticationController.verifyCode);
...
router.post('/user/signCompany', [requireAuth], AuthenticationController.signCompany);
...
//contact manage
router.post('/contacts/create',[requireAuth], contactController.create);
router.get('/contacts/getAll', [requireAuth], contactController.get);
router.post('/contacts/update',[requireAuth], contactController.update);
router.post('/contacts/del',[requireAuth], contactController.del);

//business_contact manage
router.post('/business_contacts/getDepts',[requireAuth],businessContactController.getDepts);
router.post('/business_contacts/createDepts',[requireAuth],businessContactController.createDepts);
router.post('/business_contacts/editDepts',[requireAuth],businessContactController.editDepts);
router.post('/business_contacts/delDepts',[requireAuth],businessContactController.delDepts);
router.post('/business_contacts/getBContacts',[requireAuth],businessContactController.getBContacts);
router.post('/business_contacts/createBContacts',[requireAuth],businessContactController.createBContacts);
router.post('/business_contacts/editBContacts',[requireAuth],businessContactController.editBContacts);
router.post('/business_contacts/delBContacts',[requireAuth],businessContactController.delBContacts);
router.post('/business_contacts/getDeptIdOrcreate',[requireAuth],businessContactController.getDeptIdOrcreate);

//plans manage
router.get('/plans/getCountrys', plansController.getCountrys);
router.post('/plans/buyPlan', [requireAuth], plansController.buyPlan);
router.post('/plans/all', [requireAuth], plansController.getAllPlans);
router.post('/plans/aboutExpire', [requireAuth], plansController.getAboutExpire);
router.post('/plans/expired', [requireAuth], plansController.getExpired);
