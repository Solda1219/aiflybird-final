...
import { ForgotPassLayoutComponent } from './containers/forgot-pass-layout/forgot-pass-layout.component';
...
@NgModule({
  ...
  declarations: [
    ...
    MeetingsComponent,
    VerifyComponent,
    ForgotPassLayoutComponent,
    ChangePassComponent,
    ChangeSuccessComponent,
    ContactsComponent,
    BusinessContactsComponent,
    PlansAllComponent,
    PlansAboutExpireComponent,
    PlansExpiredComponent,
    PlansBuyComponent,
  ],
  exports:[
    HorizonLayoutComponent,
